...
#  Page setup 
st.set_page_config(page_title="Image Classifier project-Angel", layout="wide")
st.title("Angel's Cats vs Dogs Classifier")
...
if retrain_folder is not None:
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        train_ds = tf.keras.utils.image_dataset_from_directory(
            tmpdir, image_size=IMG_SIZE, batch_size=16, label_mode="int",
